...
const TEMPLATE_DEFAULTS = {
  master: { format:'landscape', backgroundPreset:'officialBg', headline:'THE WORLD COMES TO ROMANIA', hostedText:'HOSTED BY ROMANIAN PADBOL FEDERATION', hashtag:'#PadbolWorldCupRomania2026', agencySupportText:'', styles:{ headline:{x:50,y:82,size:6.7,scale:1,anchor:'middle',maxW:72}, hostedText:{x:50,y:90,size:2.8,scale:1,anchor:'middle',maxW:66}, hashtag:{x:88,y:96.2,size:2.7,scale:1,anchor:'end',maxW:36}, agencySupportText:{x:50,y:97.4,size:1.6,scale:1,anchor:'middle',maxW:52} }, mainLogo:{preset:'logo1',useCustom:false,show:true,x:50,y:23,w:27,outline:false,outlineWidth:0,outlineColor:'#ffffff'}, frp:{preset:'frp1',useCustom:false,show:false,x:10,y:12,w:13,outline:false,outlineWidth:0,outlineColor:'#ffffff'}, agency:{preset:'agency1',useCustom:false,show:false,x:90,y:10,w:12,outline:false,outlineWidth:0,outlineColor:'#ffffff'} },
...
const LOGO_PRESETS = {
  ...
  frp:[{value:'none',label:'None / hide this logo'},{value:'frp1',label:'FRP Option 1'},{value:'frp2',label:'FRP Option 2'}],
  agency:[{value:'none',label:'None / hide this logo'},{value:'agency1',label:'Agency Option 1 — official lockup (default)'},{value:'agency2',label:'Agency Option 2 — square seal'},{value:'agency3',label:'Agency Option 3 — full lockup'}]
};
const FLAG_LIST = [{"code": "af", "name": "Afghanistan", "search": "Afghanistan Afghanistan Islamic Republic of Afghanistan AF AFG"}, {"code": "al", "name": "Albania", "search": "Albania Albania Republic of Albania AL ALB"}, {"code": "dz", "name": "Algeria", "search": "Algeria Algeria People's Democratic Republic of Algeria DZ DZA"}, {"code": "as", "name": "American Samoa", "search": "American Samoa American Samoa  AS ASM"}, {"code": "ad", "name": "Andorra", "search": "Andorra Andorra Principality of Andorra AD AND"}, {"code": "ao", "name": "Angola", "search": "Angola Angola Republic of Angola AO AGO"}, {"code": "ai", "name": "Anguilla", "search": "Anguilla Anguilla  AI AIA"}, {"code": "aq", "name": "Antarctica", "search": "Antarctica Antarctica  AQ ATA"}, {"code": "ag", "name": "Antigua and Barbuda", "search": "Antigua and Barbuda Antigua and Barbuda  AG ATG"}, {"code": "ar", "name": "Argentina", "search": "Argentina Argentina Argentine Republic AR ARG"}, {"code": "am", "name": "Armenia", "search": "Armenia Armenia Republic of Armenia AM ARM"}, {"code": "aw", "name": "Aruba", "search": "Aruba Aruba  AW ABW"}, {"code": "au", "name": "Australia", "search": "Australia Australia  AU AUS"}, {"code": "at", "name": "Austria", "search": "Austria Austria Republic of Austria AT AUT"}, {"code": "az", "name": "Azerbaijan", "search": "Azerbaijan Azerbaijan Republic of Azerbaijan AZ AZE"}, {"code": "bs", "name": "Bahamas", "search": "Bahamas Bahamas Commonwealth of the Bahamas BS BHS"}, {"code": "bh", "name": "Bahrain", "search": "Bahrain Bahrain Kingdom of Bahrain BH BHR"}, {"code": "bd", "name": "Bangladesh", "search": "Bangladesh Bangladesh People's Republic of Bangladesh BD BGD"}, {"code": "bb", "name": "Barbados", "search": "Barbados Barbados  BB BRB"}, {"code": "by", "name": "Belarus", "search": "Belarus Belarus Republic of Belarus BY BLR"}, {"code": "be", "name": "Belgium", "search": "Belgium Belgium Kingdom of Belgium BE BEL"}, {"code": "bz", "name": "Belize", "search": "Belize Belize  BZ BLZ"}, {"code": "bj", "name": "Benin", "search": "Benin Benin Republic of Benin BJ BEN"}, {"code": "bm", "name": "Bermuda", "search": "Bermuda Bermuda  BM BMU"}, {"code": "bt", "name": "Bhutan", "search": "Bhutan Bhutan Kingdom of Bhutan BT BTN"}, {"code": "bo", "name": "Bolivia", "search": "Bolivia Bolivia, Plurinational State of Plurinational State of Bolivia BO BOL"}, {"code": "bq", "name": "Bonaire, Sint Eustatius and Saba", "search": "Bonaire, Sint Eustatius and Saba Bonaire, Sint Eustatius and Saba Bonaire, Sint Eustatius and Saba BQ BES"}, {"code": "ba", "name": "Bosnia and Herzegovina", "search": "Bosnia and Herzegovina Bosnia and Herzegovina Republic of Bosnia and Herzegovina BA BIH"}, {"code": "bw", "name": "Botswana", "search": "Botswana Botswana Republic of Botswana BW BWA"}, {"code": "bv", "name": "Bouvet Island", "search": "Bouvet Island Bouvet Island  BV BVT"}, {"code": "br", "name": "Brazil", "search": "Brazil Brazil Federative Republic of Brazil BR BRA"}, {"code": "io", "name": "British Indian Ocean Territory", "search": "British Indian Ocean Territory British Indian Ocean Territory  IO IOT"}, {"code": "bn", "name": "Brunei Darussalam", "search": "Brunei Darussalam Brunei Darussalam  BN BRN"}, {"code": "bg", "name": "Bulgaria", "search": "Bulgaria Bulgaria Republic of Bulgaria BG BGR"}, {"code": "bf", "name": "Burkina Faso", "search": "Burkina Faso Burkina Faso  BF BFA"}, {"code": "bi", "name": "Burundi", "search": "Burundi Burundi Republic of Burundi BI BDI"}, {"code": "cv", "name": "Cabo Verde", "search": "Cabo Verde Cabo Verde Republic of Cabo Verde CV CPV"}, {"code": "kh", "name": "Cambodia", "search": "Cambodia Cambodia Kingdom of Cambodia KH KHM"}, {"code": "cm", "name": "Cameroon", "search": "Cameroon Cameroon Republic of Cameroon CM CMR"}, {"code": "ca", "name": "Canada", "search": "Canada Canada  CA CAN"}, {"code": "ky", "name": "Cayman Islands", "search": "Cayman Islands Cayman Islands  KY CYM"}, {"code": "cf", "name": "Central African Republic", "search": "Central African Republic Central African Republic  CF CAF"}, {"code": "td", "name": "Chad", "search": "Chad Chad Republic of Chad TD TCD"}, {"code": "cl", "name": "Chile", "search": "Chile Chile Republic of Chile CL CHL"}, {"code": "cn", "name": "China", "search": "China China People's Republic of China CN CHN"}, {"code": "cx", "name": "Christmas Island", "search": "Christmas Island Christmas Island  CX CXR"}, {"code": "cc", "name": "Cocos (Keeling) Islands", "search": "Cocos (Keeling) Islands Cocos (Keeling) Islands  CC CCK"}, {"code": "co", "name": "Colombia", "search": "Colombia Colombia Republic of Colombia CO COL"}, {"code": "km", "name": "Comoros", "search": "Comoros Comoros Union of the Comoros KM COM"}, {"code": "cg", "name": "Congo", "search": "Congo Congo Republic of the Congo CG COG"}, {"code": "cd", "name": "Congo, The Democratic Republic of the", "search": "Congo, The Democratic Republic of the Congo, The Democratic Republic of the  CD COD"}, {"code": "ck", "name": "Cook Islands", "search": "Cook Islands Cook Islands  CK COK"}, {"code": "cr", "name": "Costa Rica", "search": "Costa Rica Costa Rica Republic of Costa Rica CR CRI"}, {"code": "hr", "name": "Croatia", "search": "Croatia Croatia Republic of Croatia HR HRV"}, {"code": "cu", "name": "Cuba", "search": "Cuba Cuba Republic of Cuba CU CUB"}, {"code": "cw", "name": "Curaçao", "search": "Curaçao Curaçao Curaçao CW CUW"}, {"code": "cy", "name": "Cyprus", "search": "Cyprus Cyprus Republic of Cyprus CY CYP"}, {"code": "cz", "name": "Czechia", "search": "Czechia Czechia Czech Republic CZ CZE"}, {"code": "ci", "name": "Côte d'Ivoire", "search": "Côte d'Ivoire Côte d'Ivoire Republic of Côte d'Ivoire CI CIV"}, {"code": "dk", "name": "Denmark", "search": "Denmark Denmark Kingdom of Denmark DK DNK"}, {"code": "dj", "name": "Djibouti", "search": "Djibouti Djibouti Republic of Djibouti DJ DJI"}, {"code": "dm", "name": "Dominica", "search": "Dominica Dominica Commonwealth of Dominica DM DMA"}, {"code": "do", "name": "Dominican Republic", "search": "Dominican Republic Dominican Republic  DO DOM"}, {"code": "ec", "name": "Ecuador", "search": "Ecuador Ecuador Republic of Ecuador EC ECU"}, {"code": "eg", "name": "Egypt", "search": "Egypt Egypt Arab Republic of Egypt EG EGY"}, {"code": "sv", "name": "El Salvador", "search": "El Salvador El Salvador Republic of El Salvador SV SLV"}, {"code": "gq", "name": "Equatorial Guinea", "search": "Equatorial Guinea Equatorial Guinea Republic of Equatorial Guinea GQ GNQ"}, {"code": "er", "name": "Eritrea", "search": "Eritrea Eritrea the State of Eritrea ER ERI"}, {"code": "ee", "name": "Estonia", "search": "Estonia Estonia Republic of Estonia EE EST"}, {"code": "sz", "name": "Eswatini", "search": "Eswatini Eswatini Kingdom of Eswatini SZ SWZ"}, {"code": "et", "name": "Ethiopia", "search": "Ethiopia Ethiopia Federal Democratic Republic of Ethiopia ET ETH"}, {"code": "eu", "name": "European Union", "search": "European Union EU"}, {"code": "fk", "name": "Falkland Islands (Malvinas)", "search": "Falkland Islands (Malvinas) Falkland Islands (Malvinas)  FK FLK"}, {"code": "fo", "name": "Faroe Islands", "search": "Faroe Islands Faroe Islands  FO FRO"}, {"code": "fj", "name": "Fiji", "search": "Fiji Fiji Republic of Fiji FJ FJI"}, {"code": "fi", "name": "Finland", "search": "Finland Finland Republic of Finland FI FIN"}, {"code": "fr", "name": "France", "search": "France France French Republic FR FRA"}, {"code": "gf", "name": "French Guiana", "search": "French Guiana French Guiana  GF GUF"}, {"code": "pf", "name": "French Polynesia", "search": "French Polynesia French Polynesia  PF PYF"}, {"code": "tf", "name": "French Southern Territories", "search": "French Southern Territories French Southern Territories  TF ATF"}, {"code": "ga", "name": "Gabon", "search": "Gabon Gabon Gabonese Republic GA GAB"}, {"code": "gm", "name": "Gambia", "search": "Gambia Gambia Republic of the Gambia GM GMB"}, {"code": "ge", "name": "Georgia", "search": "Georgia Georgia  GE GEO"}, {"code": "de", "name": "Germany", "search": "Germany Germany Federal Republic of Germany DE DEU"}, {"code": "gh", "name": "Ghana", "search": "Ghana Ghana Republic of Ghana GH GHA"}, {"code": "gi", "name": "Gibraltar", "search": "Gibraltar Gibraltar  GI GIB"}, {"code": "gr", "name": "Greece", "search": "Greece Greece Hellenic Republic GR GRC"}, {"code": "gl", "name": "Greenland", "search": "Greenland Greenland  GL GRL"}, {"code": "gd", "name": "Grenada", "search": "Grenada Grenada  GD GRD"}, {"code": "gp", "name": "Guadeloupe", "search": "Guadeloupe Guadeloupe  GP GLP"}, {"code": "gu", "name": "Guam", "search": "Guam Guam  GU GUM"}, {"code": "gt", "name": "Guatemala", "search": "Guatemala Guatemala Republic of Guatemala GT GTM"}, {"code": "gg", "name": "Guernsey", "search": "Guernsey Guernsey  GG GGY"}, {"code": "gn", "name": "Guinea", "search": "Guinea Guinea Republic of Guinea GN GIN"}, {"code": "gw", "name": "Guinea-Bissau", "search": "Guinea-Bissau Guinea-Bissau Republic of Guinea-Bissau GW GNB"}, {"code": "gy", "name": "Guyana", "search": "Guyana Guyana Republic of Guyana GY GUY"}, {"code": "ht", "name": "Haiti", "search": "Haiti Haiti Republic of Haiti HT HTI"}, {"code": "hm", "name": "Heard Island and McDonald Islands", "search": "Heard Island and McDonald Islands Heard Island and McDonald Islands  HM HMD"}, {"code": "va", "name": "Holy See (Vatican City State)", "search": "Holy See (Vatican City State) Holy See (Vatican City State)  VA VAT"}, {"code": "hn", "name": "Honduras", "search": "Honduras Honduras Republic of Honduras HN HND"}, {"code": "hk", "name": "Hong Kong", "search": "Hong Kong Hong Kong Hong Kong Special Administrative Region of China HK HKG"}, {"code": "hu", "name": "Hungary", "search": "Hungary Hungary Hungary HU HUN"}, {"code": "is", "name": "Iceland", "search": "Iceland Iceland Republic of Iceland IS ISL"}, {"code": "in", "name": "India", "search": "India India Republic of India IN IND"}, {"code": "id", "name": "Indonesia", "search": "Indonesia Indonesia Republic of Indonesia ID IDN"}, {"code": "ir", "name": "Iran", "search": "Iran Iran, Islamic Republic of Islamic Republic of Iran IR IRN"}, {"code": "iq", "name": "Iraq", "search": "Iraq Iraq Republic of Iraq IQ IRQ"}, {"code": "ie", "name": "Ireland", "search": "Ireland Ireland  IE IRL"}, {"code": "im", "name": "Isle of Man", "search": "Isle of Man Isle of Man  IM IMN"}, {"code": "il", "name": "Israel", "search": "Israel Israel State of Israel IL ISR"}, {"code": "it", "name": "Italy", "search": "Italy Italy Italian Republic IT ITA"}, {"code": "jm", "name": "Jamaica", "search": "Jamaica Jamaica  JM JAM"}, {"code": "jp", "name": "Japan", "search": "Japan Japan  JP JPN"}, {"code": "je", "name": "Jersey", "search": "Jersey Jersey  JE JEY"}, {"code": "jo", "name": "Jordan", "search": "Jordan Jordan Hashemite Kingdom of Jordan JO JOR"}, {"code": "kz", "name": "Kazakhstan", "search": "Kazakhstan Kazakhstan Republic of Kazakhstan KZ KAZ"}, {"code": "ke", "name": "Kenya", "search": "Kenya Kenya Republic of Kenya KE KEN"}, {"code": "ki", "name": "Kiribati", "search": "Kiribati Kiribati Republic of Kiribati KI KIR"}, {"code": "kw", "name": "Kuwait", "search": "Kuwait Kuwait State of Kuwait KW KWT"}, {"code": "kg", "name": "Kyrgyzstan", "search": "Kyrgyzstan Kyrgyzstan Kyrgyz Republic KG KGZ"}, {"code": "la", "name": "Laos", "search": "Laos Lao People's Democratic Republic  LA LAO"}, {"code": "lv", "name": "Latvia", "search": "Latvia Latvia Republic of Latvia LV LVA"}, {"code": "lb", "name": "Lebanon", "search": "Lebanon Lebanon Lebanese Republic LB LBN"}, {"code": "ls", "name": "Lesotho", "search": "Lesotho Lesotho Kingdom of Lesotho LS LSO"}, {"code": "lr", "name": "Liberia", "search": "Liberia Liberia Republic of Liberia LR LBR"}, {"code": "ly", "name": "Libya", "search": "Libya Libya Libya LY LBY"}, {"code": "li", "name": "Liechtenstein", "search": "Liechtenstein Liechtenstein Principality of Liechtenstein LI LIE"}, {"code": "lt", "name": "Lithuania", "search": "Lithuania Lithuania Republic of Lithuania LT LTU"}, {"code": "lu", "name": "Luxembourg", "search": "Luxembourg Luxembourg Grand Duchy of Luxembourg LU LUX"}, {"code": "mo", "name": "Macao", "search": "Macao Macao Macao Special Administrative Region of China MO MAC"}, {"code": "mg", "name": "Madagascar", "search": "Madagascar Madagascar Republic of Madagascar MG MDG"}, {"code": "mw", "name": "Malawi", "search": "Malawi Malawi Republic of Malawi MW MWI"}, {"code": "my", "name": "Malaysia", "search": "Malaysia Malaysia  MY MYS"}, {"code": "mv", "name": "Maldives", "search": "Maldives Maldives Republic of Maldives MV MDV"}, {"code": "ml", "name": "Mali", "search": "Mali Mali Republic of Mali ML MLI"}, {"code": "mt", "name": "Malta", "search": "Malta Malta Republic of Malta MT MLT"}, {"code": "mh", "name": "Marshall Islands", "search": "Marshall Islands Marshall Islands Republic of the Marshall Islands MH MHL"}, {"code": "mq", "name": "Martinique", "search": "Martinique Martinique  MQ MTQ"}, {"code": "mr", "name": "Mauritania", "search": "Mauritania Mauritania Islamic Republic of Mauritania MR MRT"}, {"code": "mu", "name": "Mauritius", "search": "Mauritius Mauritius Republic of Mauritius MU MUS"}, {"code": "yt", "name": "Mayotte", "search": "Mayotte Mayotte  YT MYT"}, {"code": "mx", "name": "Mexico", "search": "Mexico Mexico United Mexican States MX MEX"}, {"code": "fm", "name": "Micronesia, Federated States of", "search": "Micronesia, Federated States of Micronesia, Federated States of Federated States of Micronesia FM FSM"}, {"code": "md", "name": "Moldova", "search": "Moldova Moldova, Republic of Republic of Moldova MD MDA"}, {"code": "mc", "name": "Monaco", "search": "Monaco Monaco Principality of Monaco MC MCO"}, {"code": "mn", "name": "Mongolia", "search": "Mongolia Mongolia  MN MNG"}, {"code": "me", "name": "Montenegro", "search": "Montenegro Montenegro Montenegro ME MNE"}, {"code": "ms", "name": "Montserrat", "search": "Montserrat Montserrat  MS MSR"}, {"code": "ma", "name": "Morocco", "search": "Morocco Morocco Kingdom of Morocco MA MAR"}, {"code": "mz", "name": "Mozambique", "search": "Mozambique Mozambique Republic of Mozambique MZ MOZ"}, {"code": "mm", "name": "Myanmar", "search": "Myanmar Myanmar Republic of Myanmar MM MMR"}, {"code": "na", "name": "Namibia", "search": "Namibia Namibia Republic of Namibia NA NAM"}, {"code": "nr", "name": "Nauru", "search": "Nauru Nauru Republic of Nauru NR NRU"}, {"code": "np", "name": "Nepal", "search": "Nepal Nepal Federal Democratic Republic of Nepal NP NPL"}, {"code": "nl", "name": "Netherlands", "search": "Netherlands Netherlands Kingdom of the Netherlands NL NLD"}, {"code": "nc", "name": "New Caledonia", "search": "New Caledonia New Caledonia  NC NCL"}, {"code": "nz", "name": "New Zealand", "search": "New Zealand New Zealand  NZ NZL"}, {"code": "ni", "name": "Nicaragua", "search": "Nicaragua Nicaragua Republic of Nicaragua NI NIC"}, {"code": "ne", "name": "Niger", "search": "Niger Niger Republic of the Niger NE NER"}, {"code": "ng", "name": "Nigeria", "search": "Nigeria Nigeria Federal Republic of Nigeria NG NGA"}, {"code": "nu", "name": "Niue", "search": "Niue Niue Niue NU NIU"}, {"code": "nf", "name": "Norfolk Island", "search": "Norfolk Island Norfolk Island  NF NFK"}, {"code": "kp", "name": "North Korea", "search": "North Korea Korea, Democratic People's Republic of Democratic People's Republic of Korea KP PRK"}, {"code": "mk", "name": "North Macedonia", "search": "North Macedonia North Macedonia Republic of North Macedonia MK MKD"}, {"code": "mp", "name": "Northern Mariana Islands", "search": "Northern Mariana Islands Northern Mariana Islands Commonwealth of the Northern Mariana Islands MP MNP"}, {"code": "no", "name": "Norway", "search": "Norway Norway Kingdom of Norway NO NOR"}, {"code": "om", "name": "Oman", "search": "Oman Oman Sultanate of Oman OM OMN"}, {"code": "pk", "name": "Pakistan", "search": "Pakistan Pakistan Islamic Republic of Pakistan PK PAK"}, {"code": "pw", "name": "Palau", "search": "Palau Palau Republic of Palau PW PLW"}, {"code": "ps", "name": "Palestine, State of", "search": "Palestine, State of Palestine, State of the State of Palestine PS PSE"}, {"code": "pa", "name": "Panama", "search": "Panama Panama Republic of Panama PA PAN"}, {"code": "pg", "name": "Papua New Guinea", "search": "Papua New Guinea Papua New Guinea Independent State of Papua New Guinea PG PNG"}, {"code": "py", "name": "Paraguay", "search": "Paraguay Paraguay Republic of Paraguay PY PRY"}, {"code": "pe", "name": "Peru", "search": "Peru Peru Republic of Peru PE PER"}, {"code": "ph", "name": "Philippines", "search": "Philippines Philippines Republic of the Philippines PH PHL"}, {"code": "pn", "name": "Pitcairn", "search": "Pitcairn Pitcairn  PN PCN"}, {"code": "pl", "name": "Poland", "search": "Poland Poland Republic of Poland PL POL"}, {"code": "pt", "name": "Portugal", "search": "Portugal Portugal Portuguese Republic PT PRT"}, {"code": "pr", "name": "Puerto Rico", "search": "Puerto Rico Puerto Rico  PR PRI"}, {"code": "qa", "name": "Qatar", "search": "Qatar Qatar State of Qatar QA QAT"}, {"code": "ro", "name": "Romania", "search": "Romania Romania  RO ROU"}, {"code": "ru", "name": "Russian Federation", "search": "Russian Federation Russian Federation  RU RUS"}, {"code": "rw", "name": "Rwanda", "search": "Rwanda Rwanda Rwandese Republic RW RWA"}, {"code": "re", "name": "Réunion", "search": "Réunion Réunion  RE REU"}, {"code": "bl", "name": "Saint Barthélemy", "search": "Saint Barthélemy Saint Barthélemy  BL BLM"}, {"code": "sh", "name": "Saint Helena, Ascension and Tristan da Cunha", "search": "Saint Helena, Ascension and Tristan da Cunha Saint Helena, Ascension and Tristan da Cunha  SH SHN"}, {"code": "kn", "name": "Saint Kitts and Nevis", "search": "Saint Kitts and Nevis Saint Kitts and Nevis  KN KNA"}, {"code": "lc", "name": "Saint Lucia", "search": "Saint Lucia Saint Lucia  LC LCA"}, {"code": "mf", "name": "Saint Martin (French part)", "search": "Saint Martin (French part) Saint Martin (French part)  MF MAF"}, {"code": "pm", "name": "Saint Pierre and Miquelon", "search": "Saint Pierre and Miquelon Saint Pierre and Miquelon  PM SPM"}, {"code": "vc", "name": "Saint Vincent and the Grenadines", "search": "Saint Vincent and the Grenadines Saint Vincent and the Grenadines  VC VCT"}, {"code": "ws", "name": "Samoa", "search": "Samoa Samoa Independent State of Samoa WS WSM"}, {"code": "sm", "name": "San Marino", "search": "San Marino San Marino Republic of San Marino SM SMR"}, {"code": "st", "name": "Sao Tome and Principe", "search": "Sao Tome and Principe Sao Tome and Principe Democratic Republic of Sao Tome and Principe ST STP"}, {"code": "sa", "name": "Saudi Arabia", "search": "Saudi Arabia Saudi Arabia Kingdom of Saudi Arabia SA SAU"}, {"code": "sn", "name": "Senegal", "search": "Senegal Senegal Republic of Senegal SN SEN"}, {"code": "rs", "name": "Serbia", "search": "Serbia Serbia Republic of Serbia RS SRB"}, {"code": "sc", "name": "Seychelles", "search": "Seychelles Seychelles Republic of Seychelles SC SYC"}, {"code": "sl", "name": "Sierra Leone", "search": "Sierra Leone Sierra Leone Republic of Sierra Leone SL SLE"}, {"code": "sg", "name": "Singapore", "search": "Singapore Singapore Republic of Singapore SG SGP"}, {"code": "sx", "name": "Sint Maarten (Dutch part)", "search": "Sint Maarten (Dutch part) Sint Maarten (Dutch part) Sint Maarten (Dutch part) SX SXM"}, {"code": "sk", "name": "Slovakia", "search": "Slovakia Slovakia Slovak Republic SK SVK"}, {"code": "si", "name": "Slovenia", "search": "Slovenia Slovenia Republic of Slovenia SI SVN"}, {"code": "sb", "name": "Solomon Islands", "search": "Solomon Islands Solomon Islands  SB SLB"}, {"code": "so", "name": "Somalia", "search": "Somalia Somalia Federal Republic of Somalia SO SOM"}, {"code": "za", "name": "South Africa", "search": "South Africa South Africa Republic of South Africa ZA ZAF"}, {"code": "gs", "name": "South Georgia and the South Sandwich Islands", "search": "South Georgia and the South Sandwich Islands South Georgia and the South Sandwich Islands  GS SGS"}, {"code": "kr", "name": "South Korea", "search": "South Korea Korea, Republic of  KR KOR"}, {"code": "ss", "name": "South Sudan", "search": "South Sudan South Sudan Republic of South Sudan SS SSD"}, {"code": "es", "name": "Spain", "search": "Spain Spain Kingdom of Spain ES ESP"}, {"code": "lk", "name": "Sri Lanka", "search": "Sri Lanka Sri Lanka Democratic Socialist Republic of Sri Lanka LK LKA"}, {"code": "sd", "name": "Sudan", "search": "Sudan Sudan Republic of the Sudan SD SDN"}, {"code": "sr", "name": "Suriname", "search": "Suriname Suriname Republic of Suriname SR SUR"}, {"code": "sj", "name": "Svalbard and Jan Mayen", "search": "Svalbard and Jan Mayen Svalbard and Jan Mayen  SJ SJM"}, {"code": "se", "name": "Sweden", "search": "Sweden Sweden Kingdom of Sweden SE SWE"}, {"code": "ch", "name": "Switzerland", "search": "Switzerland Switzerland Swiss Confederation CH CHE"}, {"code": "sy", "name": "Syria", "search": "Syria Syrian Arab Republic  SY SYR"}, {"code": "tw", "name": "Taiwan", "search": "Taiwan Taiwan, Province of China Taiwan, Province of China TW TWN"}, {"code": "tj", "name": "Tajikistan", "search": "Tajikistan Tajikistan Republic of Tajikistan TJ TJK"}, {"code": "tz", "name": "Tanzania", "search": "Tanzania Tanzania, United Republic of United Republic of Tanzania TZ TZA"}, {"code": "th", "name": "Thailand", "search": "Thailand Thailand Kingdom of Thailand TH THA"}, {"code": "tl", "name": "Timor-Leste", "search": "Timor-Leste Timor-Leste Democratic Republic of Timor-Leste TL TLS"}, {"code": "tg", "name": "Togo", "search": "Togo Togo Togolese Republic TG TGO"}, {"code": "tk", "name": "Tokelau", "search": "Tokelau Tokelau  TK TKL"}, {"code": "to", "name": "Tonga", "search": "Tonga Tonga Kingdom of Tonga TO TON"}, {"code": "tt", "name": "Trinidad and Tobago", "search": "Trinidad and Tobago Trinidad and Tobago Republic of Trinidad and Tobago TT TTO"}, {"code": "tn", "name": "Tunisia", "search": "Tunisia Tunisia Republic of Tunisia TN TUN"}, {"code": "tm", "name": "Turkmenistan", "search": "Turkmenistan Turkmenistan  TM TKM"}, {"code": "tc", "name": "Turks and Caicos Islands", "search": "Turks and Caicos Islands Turks and Caicos Islands  TC TCA"}, {"code": "tv", "name": "Tuvalu", "search": "Tuvalu Tuvalu  TV TUV"}, {"code": "tr", "name": "Türkiye", "search": "Türkiye Türkiye Republic of Türkiye TR TUR"}, {"code": "ug", "name": "Uganda", "search": "Uganda Uganda Republic of Uganda UG UGA"}, {"code": "ua", "name": "Ukraine", "search": "Ukraine Ukraine  UA UKR"}, {"code": "ae", "name": "United Arab Emirates", "search": "United Arab Emirates United Arab Emirates  AE ARE"}, {"code": "gb", "name": "United Kingdom", "search": "United Kingdom United Kingdom United Kingdom of Great Britain and Northern Ireland GB GBR"}, {"code": "un", "name": "United Nations", "search": "United Nations UN"}, {"code": "us", "name": "United States", "search": "United States United States United States of America US USA"}, {"code": "um", "name": "United States Minor Outlying Islands", "search": "United States Minor Outlying Islands United States Minor Outlying Islands  UM UMI"}, {"code": "uy", "name": "Uruguay", "search": "Uruguay Uruguay Eastern Republic of Uruguay UY URY"}, {"code": "uz", "name": "Uzbekistan", "search": "Uzbekistan Uzbekistan Republic of Uzbekistan UZ UZB"}, {"code": "vu", "name": "Vanuatu", "search": "Vanuatu Vanuatu Republic of Vanuatu VU VUT"}, {"code": "ve", "name": "Venezuela", "search": "Venezuela Venezuela, Bolivarian Republic of Bolivarian Republic of Venezuela VE VEN"}, {"code": "vn", "name": "Vietnam", "search": "Vietnam Viet Nam Socialist Republic of Viet Nam VN VNM"}, {"code": "vg", "name": "Virgin Islands, British", "search": "Virgin Islands, British Virgin Islands, British British Virgin Islands VG VGB"}, {"code": "vi", "name": "Virgin Islands, U.S.", "search": "Virgin Islands, U.S. Virgin Islands, U.S. Virgin Islands of the United States VI VIR"}, {"code": "wf", "name": "Wallis and Futuna", "search": "Wallis and Futuna Wallis and Futuna  WF WLF"}, {"code": "eh", "name": "Western Sahara", "search": "Western Sahara Western Sahara  EH ESH"}, {"code": "ye", "name": "Yemen", "search": "Yemen Yemen Republic of Yemen YE YEM"}, {"code": "zm", "name": "Zambia", "search": "Zambia Zambia Republic of Zambia ZM ZMB"}, {"code": "zw", "name": "Zimbabwe", "search": "Zimbabwe Zimbabwe Republic of Zimbabwe ZW ZWE"}, {"code": "ax", "name": "Åland Islands", "search": "Åland Islands Åland Islands  AX ALA"}];
...
function buildSelectedInspector(){
  ...
  if(['mainLogo','frp','agency'].includes(selectedKey)){
    const cfg=state[selectedKey];
    let html='';
...
function logoSection(group,title,presets,previewKeys,darkSet=[]){ const g = state[group]; const previewClass = previewKeys.length===3?'previewGrid three':'previewGrid'; return detail(title, `${checkboxControl(group+'.show', g.show, 'Show this logo')}${selectControl(group+'.preset', g.preset, presets, 'Preset version')}<div class="${previewClass}">${previewKeys.map(k=>`<button type="button" class="logoPreview ${darkSet.includes(k)?'dark':'light'} ${g.preset===k?'active':''}" data-logo-group="${group}" data-logo-preset="${k}" aria-label="Select ${group} preset ${k}"><img src="${assetSrc(k)}" alt="${k}"></button>`).join('')}</div>${checkboxControl(group+'.useCustom', g.useCustom, 'Use uploaded custom override')}${uploadControl(group==='mainLogo'?'customMainLogo':group==='frp'?'customFrpLogo':'customAgencyLogo','Upload custom image')}<p class="note compact">Click any preview image to select that logo preset.</p>`, false); }
...
function buildTemplateFields(){ let html=''; ensurePlayerEditableBoxes(); ensureBioPhotoSettings(); ensureExtraAssets(); ensureCustomTexts(); html += buildSelectedInspector();
...
function generateSvg(interactive=true){ const [w,h]=dims(state.format); let s=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">${defsBlock()}`;
  if(currentTemplate==='master'){ const bg=imageStore.photo || assetSrc(state.backgroundPreset || recommendedMasterBg(state.format || 'landscape')); s += imageCover(bg,'masterbg',0,0,w,h,0)+`<rect width="${w}" height="${h}" fill="rgba(0,10,30,.10)"/>`; s += renderLogo('mainLogo',interactive)+renderLogo('frp',interactive)+renderLogo('agency',interactive)+renderText('headline',{fill:'url(#covergoldgrad)',weight:900},interactive)+renderText('hostedText',{fill:'#ffffff',weight:800},interactive)+renderText('hashtag',{fill:'url(#covergoldgrad)',weight:700},interactive)+renderText('agencySupportText',{fill:'#dbe8ff',weight:700},interactive)+renderExtraAsset('extraAsset1',interactive)+renderExtraAsset('extraAsset2',interactive); }
  if(currentTemplate==='announcement'){ const bg=imageStore.photo || assetSrc(state.backgroundPreset || recommendedAnnouncementBg(state.format || 'landscape')); s += imageCover(bg,'announcementbg',0,0,w,h,0)+`<rect width="${w}" height="${h}" fill="rgba(0,10,30,.10)"/>`; s += renderLogo('mainLogo',interactive)+renderLogo('frp',interactive)+renderLogo('agency',interactive)+renderText('headline',{fill:'#ffffff',weight:900},interactive)+renderText('hostedText',{fill:'#ffffff',weight:850},interactive)+renderText('hashtag',{fill:'#f4f8ff',weight:700},interactive)+renderText('agencySupportText',{fill:'#eaf4ff',weight:700},interactive)+renderExtraAsset('extraAsset1',interactive)+renderExtraAsset('extraAsset2',interactive); }
  ...
  if(currentTemplate==='country'){
    ...
    if(isMainPreset){
      ...
      s += renderLogo('mainLogo',interactive)+renderLogo('frp',interactive)+renderLogo('agency',interactive)+renderText('titleLines',{fill:'#f3c739'},interactive);
      if(ov.show!==false){
...
function attachStageEvents(){
  ...
  const makeInteraction=(type,key,ev)=>{
    const r=rectOfStage();
    if(['mainLogo','frp','agency'].includes(key)) return {type,key,orig:clone(state[key]),startX:ev.clientX,startY:ev.clientY,r,active:false};
  ...
  svg.onclick=(ev)=>{
    ...
    if(n.dataset.eye){
      ...
      if(['mainLogo','frp','agency'].includes(key)){
  ...
  window.onmousemove=(ev)=>{
    ...
    if(['mainLogo','frp','agency'].includes(interaction.key)){
